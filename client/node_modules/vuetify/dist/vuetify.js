...
(function (global, factory) {
      ...
      useRender(() => {
        ...
        return vue.withDirectives(vue.createVNode(Tag, {
          ...
          default: () => [genOverlays(true, 'v-btn'), !props.icon && hasPrepend && vue.createVNode(VDefaultsProvider, {
            ...
            default: () => [((_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots)) ?? (props.icon != null && vue.createVNode(VIcon, {
              "key": "icon"
            }, null))]
  ...
  const version$1 = "3.0.0-next-20220924.0";
  ...
  const version = "3.0.0-next-20220924.0";
