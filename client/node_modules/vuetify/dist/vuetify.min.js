...
const{intersectionRef:o,isIntersecting:n}=ql(),{resizeRef:i,contentRect:s}=r(),{height:u}=Jn(),c=t.ref()
let d
t.watchEffect((()=>{var e
...
t.style.setProperty("transform",`translateY(${i}px) scale(${p})`)})))}return Ge((()=>t.createVNode(el,{class:["v-parallax",{"v-parallax--active":n.value}],ref:c,cover:!0,onLoadstart:f,onLoad:f},a))),{}}}),ms=ze({name:"VRadio",props:{...ao({falseIcon:"$radioOff",trueIcon:"$radioOn"})},setup(e,l){let{slots:a}=l
...
return{install:a}}
Ys.version="3.0.0-next-20220924.0"
const Xs=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return Ys({components:Ms,directives:Us,...e})},Gs="3.0.0-next-20220924.0"
